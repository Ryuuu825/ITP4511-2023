...
public class BookingStatusTag extends SimpleTagSupport {
    ...
    private String[] statusString = {"Pending Approval", "Rejected", "Pending Check in", "Check in", "Completed", "Cancelled", "Completed", "Pending Pay", "Pending Confirm"};
    ...
    public void doTag() throws JspException, IOException {
        try {
            ...
            if ("Member".equalsIgnoreCase(role)) {
                ...
                switch (status) {
                    case 1:
                        out.print("<button name=\"status\" value=\"8\" type=\"submit\" class=\"btn btn-lg btn-success btn-block \">");
                        out.print("Approve");
                        out.print("</button>");
